<div class="choose">
			...
			<div class="container">
				...
				<?php
					$inspiration = $pdo->query("SELECT * FROM potensi_desa WHERE potensidesa = 'TENUNAN' ORDER BY id_potensi_desa DESC");
				...
				?>
					<div class="col-md-4 choose-grid">
						...
						<div class="choose-button">
							<a href="detail-tenunan-<?php echo $gal['nama'];?>-<?php echo $gal['id_potensi_desa'];?>">Selengkapnya</a>
						</div>
					</div>
					<?php } ?>
					<div class="clearfix"> </div>
