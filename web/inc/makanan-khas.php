<div class="choose">
			...
			<div class="container">
				...
				<?php
					$inspiration = $pdo->query("SELECT * FROM potensi_desa WHERE potensidesa = 'MAKANAN KHAS' ORDER BY id_potensi_desa DESC");
				...
				?>
					<div class="col-md-4 choose-grid">
						...
						<div class="choose-button">
							<a href="detail-makanan-khas-<?php echo $gal['nama'];?>-<?php echo $gal['id_potensi_desa'];?>">Selengkapnya</a>
						</div>
					</div>
					<?php } ?>
					<div class="clearfix"> </div>
